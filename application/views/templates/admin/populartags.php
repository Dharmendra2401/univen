            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="">Add Popular Tags</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url();?>admin/populartags" name="upload_excel"
                            enctype="multipart/form-data">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label><span class="text-danger">*</span> Profile 1</label><br>
                                    <select name="ID" class="form-control selectpicker" data-hide-disabled="true"
...
function getdata() {
    $('.loader').show();
    var loadpage = "load_populartags.php";
    var model = "populartags";
    $.ajax({
        type: 'POST',
        url: "load_table",
        data: {
