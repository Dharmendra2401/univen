        ...
        <main>
            <div class="container-fluid">
                ...
                <form role="form" class="form-validation" enctype="multipart/form-data" method="post"
                    action="<?php echo base_url();?>admin/save_blog">
                    <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-md-4 form-group">
                            <div class="row">
                                ...
                                <textarea placeholder="Enter desc" required name="short_desc" class="form-control"
                                    rows="3" maxlength="165"></textarea>
...
">
                        ...
                        <div class="col-md-6 form-group">
                            <div class="row">
                                <label class="col-md-12"><strong> Description:</strong><small style="color:red;"> (min
                                        200 words to 350 word max)</small></label>
                                <textarea placeholder="Enter desc" required name="description" class="form-control"
                                    rows="5"></textarea>
                            </div>
                        </div>
                    </div>
