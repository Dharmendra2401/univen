...
function update(idu,ufirst_name,ulast_name,ucontact_no,ucompany_name,ulogo,uemail,uregistration,uverifyemail,uregistration_no,upan,ugst,uaddress,uporpuse,ustatus,uupdate,uid_proof,ucompany){

  $('#idu').val(idu);
  $('#ufirst_name').val(ufirst_name);
  $('#ulast_name').val(ulast_name);
  $('#ucontact_no').val(ucontact_no);
  $('#ucompany_name').val(ucompany_name);
  $('#ulogo').val(ulogo);
  $('#uemail').val(uemail);
...
function getdata(){
    var loadpage="load_recuiters.php";
    var model="recuiter";
    $.ajax({
    type: 'POST',
    url: "load_table",
...
function verify(id,status,table,classname){
    swal({
        title: "Are you sure?",
        text: "You want to active this recruiter!",
        icon: "warning",
        buttons: true,
        dangerMode: true,
        })
...
swal({
    title: "Are you sure?",
    text: "You want to deactive this recruiter!",
    icon: "warning",
    buttons: true,
    dangerMode: true,
    })
