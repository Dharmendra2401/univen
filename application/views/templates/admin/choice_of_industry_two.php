...
$title="Choice Of Industry (Form 2)";
?>
...
<div class="col-md-12 text-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add">Add Choice Of Industry </button><br><br>
                    </div>
                    <div class="col-md-12 ">
...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="">Update Choice Of Industry </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                    <form method="post" action="<?php echo base_url();?>admin/choice_of_industry_two" enctype='multipart/form-data'>
                    
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Choice Of Industry </label><br>
                            <input type="text" name="uname" id="uname" placeholder="Enter Choice Of Industry " class="form-control" maxlength="70">
                        </div>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="">Add Choice Of Industry</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/choice_of_industry_two" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Choice Of Industry </label><br>
                            <input type="text" name="name" id="name" placeholder="Enter Choice Of Industry " class="form-control" maxlength="70">
                        </div>
                        <span id="jerror"></span>
...
function getdata(){
    $('.loader').show();
    var loadpage="load_choice_of_industry.php";
    var model="choiceofindustry_two";
    $.ajax({
    type: 'POST',
    url: "load_table",
...
function btnclickdelete(id,table)
{
        ...
        swal({
        title: "Are you sure?",
        text: "Once deleted, you will not be able to recover this choice of industry!",
        icon: "warning",
        buttons: true,
        dangerMode: true,
        })
...
function verify(id,status,table){
    swal({
        title: "Are you sure?",
        text: "You want to active this choice of industry!",
        icon: "warning",
        buttons: true,
        dangerMode: true,
        })
...
swal({
    title: "Are you sure?",
    text: "You want to deactive this choice of industry!",
    icon: "warning",
    buttons: true,
    dangerMode: true,
    })
