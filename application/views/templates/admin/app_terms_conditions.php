...
$title="Applicant Terms & Conditions";
?>
...
<form class="p-3 border bg-light" enctype="multipart/form-data" method="post" action="<?php echo base_url();?>admin/app_terms_conditions" >
