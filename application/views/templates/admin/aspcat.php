...
$title="Aspirant Category/Section/Form";
?>
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#add-category">Add Category
                        </button><br><br>
                    </div>
                    <div class="col-md-12 ">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="">Import Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url();?>admin/aspcat" name="upload_excel"
                            ...
                            <div class="form-group">
                                <small>Please click <i><a
                                            href="<?php echo base_url();?>samples/category.xlsx">here</a></i> to
        ...
        <div class="modal fade" id="add-category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url();?>admin/aspcat" class="row">
                            ...
                            <!-- <div class="form-group col-md-6">
                                <label>Category Section </label><br>
                                <input type="text" name="Section_Name" id="sectionname" class="form-control"
                                    placeholder="Profile Section">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Category Form </label><br>
                                <input type="text" name="Category_form" id="catform" class="form-control"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo base_url();?>admin/aspcat" class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label><span class="text-danger">*</span> Category</label><br>
                                <input type="text" name="Category_Name" id="Category_Name" placeholder="Enter Category"
                                    class="form-control" maxlength="50">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Category Section </label><br>
...
function validate() {
    var Category = $('input[name=import').val();
    if (Category.trim() == '') {

        $('input[name=name').focus();
        $('#jerror').html(
            '<div class="alert alert-danger alert-dismissible fade show" role="alert">Please select excel <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>'
        );
        return false;
    } else {
        return true;
...
function validateone() {
    ...
    if (Category.trim() == '') {
        ...
        $('#ujerror').html(
            '<div class="alert alert-danger alert-dismissible fade show" role="alert">Please enter Category name <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>'
        );
        return false;
    } else {
        return true;
...
function update(uid, category) {
    $('#Category_ID').val(atob(uid));
    $('#Category_Name').val(atob(category));
...
function unverify(id, status, table) {
    swal({
            title: "Are you sure?",
            text: "You want to deactive this Category!",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
