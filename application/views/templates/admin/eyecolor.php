...
<div class="col-md-12 text-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add">Add Eye Color </button><br><br>
                    </div>
                    <div class="col-md-12 ">
...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="">Update Eye Color </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                    <form method="post" action="<?php echo base_url();?>admin/eyecolor" enctype='multipart/form-data'>
                    
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Eye Color </label><br>
                            <input type="text" name="uname" id="uname" placeholder="Enter Eye Color " class="form-control" maxlength="50">
                        </div>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title" id="">Add Eye Color </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/eyecolor" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Eye Color </label><br>
                            <input type="text" name="name" id="name" placeholder="Enter Eye Color " class="form-control" maxlength="50">
                        </div>
                        <span id="jerror"></span>
...
if(Category.trim()==''){
   ...
   $('#jerror').html('<div class="alert alert-danger alert-dismissible fade show" role="alert">Please enter eye color  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
    return false;
}
else{
    return true;
...
function getdata(){
    $('.loader').show();
    var loadpage="load_eyecolor.php";
    var model="eyecolor";
    $.ajax({
    type: 'POST',
    url: "load_table",
