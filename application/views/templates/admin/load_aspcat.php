        ...
        <tr>
            ...
            <td class="tablebutton">
                <a href="#" title="Update" class="rounded btn btn-sm btn-primary"
                    onclick="update('<?php echo base64_encode($index['Category_ID']);?>','<?php echo base64_encode($index['Category_Name']);?>')"
