<table id="example1" class="table table-striped table-bordered " width='100%'>
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo $i; ?></td>
            <td>
                <?php echo $PROFILE_NAME = $this->db->get_where('profile', array('PROFILE_ID'=> $index['ID']))->row()->PROFILE_NAME;?>
            </td>
            ...
            <td class="tablebutton">
                ...
                <a href="#" title="delete" data-toggle="modal"
                    onclick="return btnclickdelete('<?php echo $index['id']; ?>','aspprofile_type');"
                    class="rounded btn btn-sm btn-danger"><i class="fas fa-trash"></i></a><br>
