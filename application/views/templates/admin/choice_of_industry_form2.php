...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/choice_of_industry" enctype='multipart/form-data'>
...
function getdata(){
    $('.loader').show();
    var loadpage="load_choice_of_industry_form2.php";
    var model="choiceofindustry";
    $.ajax({
    type: 'POST',
    url: "load_table",
