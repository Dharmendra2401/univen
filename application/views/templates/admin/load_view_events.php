<table id="example1" class="table table-striped table-bordered " width='100%'>
                            ...
                            <?php $i=1;foreach($row as $index)  { 
                                ...
                                <tr class="row<?php echo $i; ?>">
                                    ...
                                    <a href="<?php echo base_url();?>admin/detail_events?token=<?php echo base64_encode($index['id'])?>" title="view details"   class="rounded btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
