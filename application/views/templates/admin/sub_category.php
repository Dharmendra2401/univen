...
<section class=" ">
    <div class="">
        <div class="">
            <section class="subcat-img-banner" style="background: transparent url(<?php echo base_url('uploads/subcategorynarration/'.$subcategories->Short_Image)?>) 0% 0% no-repeat padding-box;
...
<section class=" ">
    <div class="">
        <div class="">
            ...
            background: transparent url(<?php echo base_url('uploads/subcategorynarration/'.$subcategories->Long_Image)?>) 0% 0% no-repeat padding-box;
	background-repeat: no-repeat;
	background-size: 100% 100%;
	background-position: center center;">
                <p style="font-size: 22px;color: #fff;margin-left: 132px;
    /* margin-top: 29px; */
    padding-top: 20px;"><?php echo $subcategories->Text_On_Image?></p>
