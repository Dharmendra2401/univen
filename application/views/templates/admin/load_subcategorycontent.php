        ...
        <tr>
            ...
            <td class="tablebutton">
                <a href="#" title="Update" class="rounded btn btn-sm btn-primary"
                    onclick="update('<?php echo base64_encode($index['ID']);?>','<?php echo base64_encode($index['Long_Image']);?>','<?php echo base64_encode($index['Overview']);?>','<?php echo $index['Sub_Category_Name']; ?>')"
                ...
                <?php } ?>
                <a href="<?php echo base_url();?>admin/subcatnarrationprofileadd?token=<?php echo base64_encode($index['PROFILE_ID']); ?>"
                    class=" btn-sm btn-success">Add Profile</a>
