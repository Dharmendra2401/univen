...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/empcat" enctype='multipart/form-data'>
...
if(Category.trim()==''){
   ...
   $('#jerror').html('<div class="alert alert-danger alert-dismissible fade show" role="alert">Please enter Category name <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
    return false;
}
else{
    return true;
...
function getdata(){
    $('.loader').show();
    var loadpage="load_empcat.php";
    var model="empprofile";
    $.ajax({
    type: 'POST',
    url: "load_table",
