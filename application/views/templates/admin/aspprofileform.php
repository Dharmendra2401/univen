...
<a class="btn btn-primary btn-sm back-absolute-btn" href="<?php echo base_url();?>admin/aspprofile">Back</a>
<div class="row">
...
function getdata(){
    ...
    $('.loader').show();
    var loadpage="load_aspprofileform.php";
    var model="getprofileform";
    $.ajax({
    type: 'POST',
    url: "load_tabletwo",
