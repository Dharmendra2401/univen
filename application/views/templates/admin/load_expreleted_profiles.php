<table id="example1" class="table table-striped table-bordered " width='100%'>
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo $i; ?></td>
            <td>
                <?php echo $PROFILE_NAME = $this->db->get_where('profile', array('PROFILE_ID'=> $index['PROFILE_ID']))->row()->PROFILE_NAME;?>
            </td>
            <td>
            ...
            <td class="tablebutton">
                <a href="#" title="Update" class="rounded btn btn-sm btn-primary"
                    onclick="update('<?php echo base64_encode($index['PROFILE_ID']);?>','<?php echo base64_encode($index['PROFILE_ID']);?>')"
                ...
                <a href="#" title="delete" data-toggle="modal"
                    onclick="return btnclickdelete('<?php echo $index['ID']; ?>','profileslider');"
