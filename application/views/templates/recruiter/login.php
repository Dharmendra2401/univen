                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <img style="width:150px;margin-top: 2em; " src="<?php echo base_url();?>images/logo-Cast-India.png" alt="">
                            </div>
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center my-4 text-info">Recruiter Login</h3></div>
                                   
                                    <div class="card-body"><?php if($this->session->flashdata('error')!=''){echo $this->session->flashdata('error');}  ?>
                                        <form method="post" action="<?php echo base_url();?>recruiter/login">
                                            ...
                                            <button type="submit" name="submit" value="submit" onclick="return formvaldation()" class="btn btn-primary" >Login</button>
</div>
                                            <div class="form-group text-center">
